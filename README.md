...
- **Phase 2 — Paraphrasing (crowdsourced):** Human annotators rewrite each template utterance into natural language while preserving meaning. *(Not implemented here — human task.)*
...
Each dialogue follows the format of Table 5 in the paper — annotation and template utterance shown side by side:
